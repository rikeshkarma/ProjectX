...
class TrackingScreen extends StatefulWidget {
  static String routeName = "/tracking_screen";
  @override
...
class _TrackingScreenState extends State<TrackingScreen> {
  final List<Location> locations = [
    Location('Biratnagar Facility', DateTime(2019, 6, 5, 5, 23, 4),
        showHour: false, isHere: false, passed: true),
    Location('Chitwan Facility', DateTime(2019, 6, 6, 5, 23, 4),
        showHour: false, isHere: false, passed: true),
    Location(
      'Kathmandu Facility',
    ...
    return Container(
      decoration: BoxDecoration(
          ...
          image: DecorationImage(
              image: AssetImage('assets/images/Group 444.png'),
              fit: BoxFit.contain)),
      child: Container(
